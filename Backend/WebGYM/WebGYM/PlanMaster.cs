...
namespace WebGYM
{
    public class PlanMaster : IPlanMaster
    {
        ...
        public PlanMaster(DatabaseContext context, IConfiguration configuration)
        {
            _context = context;
        ...
        public void InsertPlan(Models.PlanMaster plan)
        {
        ...
        public bool UpdatePlanMaster(Models.PlanMaster planMaster)
        {
        ...
        public PlanMasterModel GetPlanMasterbyId(int planId)
        {
            var result = (from plan in _context.PlanMaster
                          where plan.PlanID == planId
