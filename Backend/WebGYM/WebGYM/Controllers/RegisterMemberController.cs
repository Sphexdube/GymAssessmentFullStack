...
namespace WebGYM.Controllers
{
    ...
    public class RegisterMemberController : ControllerBase
    {
        ...
        public MemberRegistrationModel Get(int id)
        {
        ...
        [HttpPost]
        public HttpResponseMessage Post([FromBody] MemberRegistrationModel member)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    if (!_memberRegistration.CheckNameExits(member.MemberFName, member.MemberLName, member.MemberMName))
                    {
                        ...
                        var automember = AutoMapper.Mapper.Map<Models.MemberRegistration>(member);
        ...
        [HttpPut("{id}")]
        public HttpResponseMessage Put(int id, [FromBody] MemberRegistrationModel member)
        {
