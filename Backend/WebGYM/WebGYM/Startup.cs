...
namespace WebGYM
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ISchemeMaster, SchemeMaster>();
            services.AddTransient<IPlanMaster, PlanMaster>();
            services.AddTransient<IPeriodMaster, PeriodMaster>();
            services.AddTransient<IRole, Role>();
            services.AddTransient<IMemberRegistration, MemberRegistration>();
            services.AddTransient<IUsers, Users>();
            services.AddTransient<IUsersInRoles, UsersInRoles>();
            services.AddTransient<IPaymentDetails, PaymentDetailsConcrete>();
            services.AddTransient<IRenewal, Renewal>();
            services.AddTransient<IReports, ReportsMaster>();
            services.AddTransient<IGenerateRecepit, GenerateRecepit>();
