...
namespace WebGYM.Mappings
{
    public class MappingProfile : Profile
    {
        ...
        {
            CreateMap<SchemeMasterModel, Models.SchemeMaster>()
                .ForMember(dest => dest.SchemeName, opt => opt.MapFrom(src => src.SchemeName))
                .ForMember(dest => dest.Status, opt => opt.MapFrom(src => src.Status));

            CreateMap<SchemeMasterEditViewModel, Models.SchemeMaster>()
                .ForMember(dest => dest.SchemeName, opt => opt.MapFrom(src => src.SchemeName))
                .ForMember(dest => dest.SchemeID, opt => opt.MapFrom(src => src.SchemeID))
                .ForMember(dest => dest.Status, opt => opt.MapFrom(src => src.Status));

            CreateMap<PlanMasterModel, Models.PlanMaster>()
            ...
            CreateMap<Models.Role, RoleViewModel>()
                .ForMember(dest => dest.RoleName, opt => opt.MapFrom(src => src.RoleName))
                .ForMember(dest => dest.Status, opt => opt.MapFrom(src => src.Status));

            CreateMap<MemberRegistrationModel, Models.MemberRegistration>()
            ...
            CreateMap<UsersViewModel, Models.Users>()
