...
namespace WebGYM
{
    public class MemberRegistration : IMemberRegistration
    {
        ...
        public MemberRegistration(DatabaseContext context, IConfiguration configuration)
        {
            _context = context;
        ...
        public MemberRegistrationModel GetMemberbyId(int memberId)
        {
            using (SqlConnection con = new SqlConnection(_configuration.GetConnectionString("DatabaseConnection")))
            {
                var para = new DynamicParameters();
                para.Add("@MemberId", memberId);
                return con.Query<MemberRegistrationModel>("sprocMemberRegistrationSelectSingleItem", para, null, true, 0, commandType: CommandType.StoredProcedure).Single();
            }
        }
        ...
        public int InsertMember(Models.MemberRegistration memberRegistration)
        {
        ...
        public int UpdateMember(Models.MemberRegistration memberRegistration)
        {
            using (var con = new SqlConnection(_configuration.GetConnectionString("DatabaseConnection")))
            {
                con.Open();
