...
namespace WebGYM
{
    public class PaymentDetailsConcrete : IPaymentDetails
    {
        ...
        public IQueryable<PaymentDetailsModel> GetAll(QueryParameters queryParameters, int userId)
        {
            IQueryable<PaymentDetailsModel> allItems = (from payment in _context.PaymentDetails
                                                            ...
                                                            select new PaymentDetailsModel()
                                                            {
        ...
        public bool RenewalPayment(RenewalModel renewalViewModel)
        {
